...
<img alt="Payment Options" src="./Payment_files/payment-options.webp" style="margin-top: -8px;">
</label>
</div>
</div>
<div>
...
<div class="radio">
<label>
<input type="radio" data-bind="value: &#39;ECC&#39;, checked: SelectedPaymentValue,click: paymentMethodChange.bind($data, &#39;ECC&#39;)" name="PaymentMethodSelection" value="ECC">
