...
stjude.dprforms.livechat=(function(a){return{init:function(f,e,d,c,b){a.ajaxSetup({cache:true});
a.getScript("/etc/clientlibs/stjude/dprforms/livechat/js/salesforce-livechat-45.js",function(){liveagent.init(e,c,d);
liveagent.addCustomDetail("Channel Name",b);
if(f=="true"){liveagent.enableLogging()
}})
}}
})(jQuery);
(function(){function Ca(a){switch(a){case"'":return"\x26#39;";
...
default:return a
}}function l(){}function t(){}function la(a){l.prototype.init.call(this,a,l.TYPE.STANDARD)
}function ma(a){k[a]||(k[a]=new la(a));
return k[a]
}function T(a,b){l.prototype.init.call(this,b+"_"+a,l.TYPE.AGENT)
}function L(a,b){var c=b+"_"+a;
k[c]||(k[c]=new T(a,b));
return k[c]
}function U(a,b){t.prototype.init.call(this,a,b)
}function V(a,b){t.prototype.init.call(this,a,b)
...
}function u(a){k[a]||(k[a]=new n(a));
return k[a]
}function A(a,b,c,e,d,g,C,y){t.prototype.init.call(this,a,b);
...
}function D(a){return u(a)?u(a).getTracker():null
}function r(){}function J(a,b,c,e){r.prototype.init.call(this,a,b,c,e)
}function K(a,b,c,e){r.prototype.init.call(this,a,b,null,e)
}function M(a,b,c,e){r.prototype.init.call(this,a,b,null,e)
}function E(a,b,c,e){E.prototype.init.call(this,a,b,null,null)
}function h(){}function N(a,b,c,e,d){h.prototype.init.call(this,a,b,c,e,d)
}function O(a,b,c,e,d){h.prototype.init.call(this,a,b,c,e,d)
}function W(a,b,c,e,d){h.prototype.init.call(this,a,b,c,e,d)
}function F(a){na++;
if(1000<na){throw Error("Error processing rule filter logic, preventing recursion")
}for(var b=0,c=0,e=0;
e<a.length;
e++){"("==a.charAt(e)?c++:")"==a.charAt(e)&&c--,","==a.charAt(e)&&1==c&&(b=e)
}if(0==a.indexOf("AND(")){return c=F(a.substring(4,b)),a=F(a.substring(b+1,a.length-1)),new X(c,a)
}if(0==a.indexOf("OR(")){return c=F(a.substring(3,b)),a=F(a.substring(b+1,a.length-1)),new Y(c,a)
}if(0==a.indexOf("NOT(")){return c=F(a.substring(4,a.length-1)),new Z(c)
}if(!isNaN(parseInt(a,10))){return new aa(parseInt(a,10))
}throw Error("Encountered unexpected character in filter logic")
}function z(){}function aa(a){this.ruleId=a;
z.prototype.init.call(this,null,null)
}function X(a,b){z.prototype.init.call(this,a,b)
}function Y(a,b){z.prototype.init.call(this,a,b)
}function Z(a){z.prototype.init.call(this,a,null)
}function Da(a,b,c,e){var d=document.createElement("div");
...
return d
}function oa(a,b,c){"undefined"==typeof c&&(c=!0);
...
}function pa(a,b,c,e,d){this.getEntityName=function(){return a
};
...
}function qa(a){this.saveToTranscript="";
this.showOnCreate=!1;
...
}function sa(a,b,c,e,d){this.getFieldName=function(){return a
};
...
ca&&(b.chatted=1);
w?(b.sid=w,f.log("Reusing existing session.")):(a.push(new q.Noun("VisitorId")),f.log("Requesting new session."));
a.push(new q.Noun("Settings",{buttonIds:"["+va()+"]",updateBreadcrumb:1,urlPrefix:m.urlPrefix}));
q.connection.send(a,b)
}function wa(){null!==Q&&clearTimeout(Q);
Q=window.setTimeout(Ea,R?0:m.pingRate)
}function xa(a,b){b.endpointUrl&&a.setEndpoint(b.endpointUrl);
b.prechatUrl&&a.setPrechat(b.prechatUrl);
b.language&&a.setLanguage(b.language);
a.setOnlineState(b.isAvailable)
}function Ea(){if(q.connection.isRunning()){if(null==w||R){R=!1,ua()
...
var b=[new q.Noun("Availability",{ids:"["+va()+"]"})];
q.connection.send(b,a)
}}}function da(){f.log("Disconnecting from Live Agent");
q.connection.setIsRunning(!1);
for(var a in k){k.hasOwnProperty(a)&&k[a].setOnlineState(!1)
}}function va(){var a=[],b={},c;
...
}function ya(a,b,c,e){document.cookie="liveagent_chatted\x3d1;path\x3d/;";
ca=!0;
var d;
...
window.open("",b,c);
Fa(b,a)
}function Fa(a,b){function c(a,b,c){var e=document.createElement("input");
e.name=b;
e.value=c;
a.appendChild(e)
...
document.body.appendChild(d);
d.submit()
}function fa(a){a?f.log("Server Warning: "+a):f.log("Server sent an anoymous warning.")
}function Ba(a){a?f.log("Server Error: "+a):f.log("Server responded with an error.")
...
}}},log:function(a){S&&window.console&&window.console.log&&window.console.log("LIVE AGENT: "+a)
},logGroupStart:function(a){S&&window.console&&(window.console.group?window.console.groupCollapsed("LIVE AGENT: "+a):f.log(a))
},logGroupEnd:function(){S&&window.console&&window.console.group&&window.console.groupEnd()
...
}function d(a,b){var c,g,f,C,y=x,k,h=b[a];
...
k=[];
if("[object Array]"===Object.prototype.toString.apply(h)){C=h.length;
for(c=0;
c<C;
c+=1){k[c]=d(c,h)||"null"
}f=0===k.length?"[]":x?"[\n"+x+k.join(",\n"+x)+"\n"+y+"]":"["+k.join(",")+"]";
x=y;
return f
}if(m&&"object"===typeof m){for(C=m.length,c=0;
c<C;
c+=1){"string"===typeof m[c]&&(g=m[c],(f=d(g,h))&&k.push(e(g)+(x?": ":":")+f))
}}else{for(g in h){Object.prototype.hasOwnProperty.call(Object(h),g)&&(f=d(g,h))&&k.push(e(g)+(x?": ":":")+f)
}}f=0===k.length?"{}":x?"{\n"+x+k.join(",\n"+x)+"\n"+y+"}":"{"+k.join(",")+"}";
x=y;
return f
...
},escapeToHtml:function(a){return null===a||void 0===a||""===a?"":a=a.replace(/[&<>"'\u00a9\u2028\u2029]/g,Ca)
...
}},ga,v={getVisitCount:function(){var a=parseInt(f.getCookie("liveagent_vc"),10);
...
}},B=new function(){function a(){return window.localStorage?window.localStorage:window.sessionStorage
...
}function e(){g.setItem(d.SESSION_ID,w);
...
this.init=function(){if(g.getItem(d.SESSION_ID)){if(g.getItem(d.SESSION_ID)!=w){g.removeItem(d.SESSION_START);
...
f.isEmpty(c)||(b+="\x26proxy\x3d"+c+"\x26proxyKey\x3d"+m.prefixKey);
b+="\x26org_id\x3d"+m.orgId;
b+="\x26deployment_id\x3d"+m.deploymentId;
b+="\x26sid\x3d"+w;
return b+="#"+a
...
l.prototype.startChat=function(a){return this.dispatchEvent(l.EVENT.BUTTON_ACCEPTED)?(ya(this.buttonId,a),!0):!1
};
l.prototype.rejectChat=function(){return this.dispatchEvent(l.EVENT.BUTTON_REJECTED)?!0:!1
};
l.prototype.dispatchEvent=function(a){return ha.hasOwnProperty(this.buttonId)?!1===ha[this.buttonId].call(this,a)?!1:!0:!0
};
t.prototype.init=function(a,b){this.buttonId=a;
this.element=b
};
t.prototype.getId=function(){return this.buttonId
};
t.prototype.setState=function(a){f.log("Setting state for button "+this.buttonId+" to "+(a?"online":"offline"));
return k[this.buttonId].dispatchEvent(a?l.EVENT.BUTTON_AVAILABLE:l.EVENT.BUTTON_UNAVAILABLE)?!0:!1
};
la.prototype=new l;
T.prototype=new l;
T.prototype.startChat=function(a,b){if(this.dispatchEvent(l.EVENT.BUTTON_ACCEPTED)){var c=this.buttonId.split("_");
ya(c[1],a,c[0],b);
return !0
}return !1
};
U.prototype=new t;
U.prototype.setState=function(a){t.prototype.setState.call(this,a)&&(this.element.style.display=a?"":"none")
};
V.prototype=new t;
V.prototype.setState=function(a){t.prototype.setState.call(this,a)&&(this.element.style.display=a?"none":"")
};
var ia=!1,G=null,ja={},H={};
n.prototype=new l;
n.RENDERER={Slide:{renderClass:J},Fade:{renderClass:K},Appear:{renderClass:M},Custom:{renderClass:E}};
...
switch(e.type){case h.TYPE.NUMBER_OF_PAGE_VIEWS:d=new N(e.order,this.buttonId,B.getPageCount(),e.operator,parseInt(e.value,10));
break;
case h.TYPE.URL_MATCH:d=new N(e.order,this.buttonId,B.getCurrentPage(),e.operator,e.value);
break;
case h.TYPE.SECONDS_ON_PAGE:d=new O(e.order,this.buttonId,(new Date).getTime(),e.operator,1000*parseInt(e.value,10));
break;
case h.TYPE.SECONDS_ON_SITE:d=new O(e.order,this.buttonId,parseInt(B.getSessionStart(),10),e.operator,1000*parseInt(e.value,10));
break;
case h.TYPE.CUSTOM_VARIABLE:d=new W(e.order,this.buttonId,e.name,e.operator,e.value),H.hasOwnProperty(e.name)||(H[e.name]=[]),H[e.name].push(this.buttonId)
...
A.prototype=new t;
A.prototype.setState=function(a){a&&!ia&&u(this.buttonId).trigger()&&t.prototype.setState.call(this,!0)?(ia=!0,G=this.buttonId,this.renderer.render()):!a&&u(this.buttonId).isActive()&&t.prototype.setState.call(this,!1)&&(ia=!1,this.remove(!0))
};
A.prototype.renderFinish=function(){u(this.buttonId).setActive(!0);
if(-1!=this.rejectTime){var a=this.buttonId;
u(this.buttonId).setAutoRejectTimeout(window.setTimeout(function(){u(a).rejectChat()
},1000*this.rejectTime))
}this.renderer.renderFinish()
};
A.prototype.accept=function(){this.hasInviteAfterAccept||f.setCookie("liveagent_invite_rejected_"+this.buttonId,!0,!1);
this.remove(!1)
};
A.prototype.reject=function(){this.hasInviteAfterReject||f.setCookie("liveagent_invite_rejected_"+this.buttonId,!0,!1);
this.remove(!0)
};
A.prototype.remove=function(a){u(this.buttonId).setActive(!1);
this.renderer.remove(a)
};
A.prototype.removeFinish=function(){this.renderer.remove(!1)
};
...
f.addEventListener(this.element,b,function(){D(a).renderFinish()
});
f.addEventListener(this.element,c,function(){D(a).removeFinish()
})
};
J.prototype=new r;
...
K.prototype=new r;
K.prototype.render=function(){r.prototype.addRenderListeners.call(this);
var a="";
""!==this.animationPrefix&&(a="-"+this.animationPrefix+"-");
...
K.prototype.renderFinish=function(){var a="";
""!==this.animationPrefix&&(a="-"+this.animationPrefix+"-");
this.element.style[a+"animation-play-state"]="paused";
this.element.style.setProperty(a+"animation-play-state","paused","")
};
K.prototype.remove=function(a){var b="";
""!==this.animationPrefix&&(b="-"+this.animationPrefix+"-");
...
M.prototype=new r;
M.prototype.render=function(){this.element.style.marginLeft=this.width*this.endPosition.xPercent*-1+this.offset*this.endPosition.xOffset+"px";
this.element.style.left=100*this.endPosition.xPercent+"%";
this.element.style.marginTop=this.height*this.endPosition.yPercent*-1+this.offset*this.endPosition.yOffset+"px";
this.element.style.top=100*this.endPosition.yPercent+"%";
r.prototype.render.call(this);
...
M.prototype.remove=function(a){a?D(this.buttonId).removeFinish():r.prototype.remove.call(this,a)
};
E.prototype=new r;
E.prototype.render=function(){D(this.buttonId).renderFinish()
};
E.prototype.renderFinish=function(){};
E.prototype.remove=function(a){a&&D(this.buttonId).removeFinish()
};
...
N.prototype=new h;
N.prototype.evaluate=function(){f.log("Evaluating StandardInviteRule");
return h.prototype.evaluate.call(this,this.compareFrom,this.compareTo)
};
O.prototype=new h;
O.prototype.evaluate=function(){f.log("Evaluating TimerInviteRule");
var a=(new Date).getTime()-this.compareFrom,b=h.prototype.evaluate.call(this,a,this.compareTo);
!b&&a<=this.compareTo&&(a=this.compareTo-a,(null==u(this.buttonId).getInviteDelay()||a<u(this.buttonId).getInviteDelay())&&u(this.buttonId).setInviteDelay(a));
return b
};
W.prototype=new h;
W.prototype.evaluate=function(){if(ja.hasOwnProperty(this.compareFrom)){return f.log("Evaluating CustomInviteRule"),h.prototype.evaluate.call(this,ja[this.compareFrom].toString(),this.compareTo)
}f.log("CustomInviteRule evaluation failed due to missing custom variable");
return !1
};
var na=0;
z.prototype.init=function(a,b){this.left=a;
this.right=b
};
z.prototype.evaluate=function(a){return !1
};
aa.prototype=new z;
aa.prototype.evaluate=function(a){f.log("Evaluating Atom Node: "+this.ruleId);
return a.getRule(this.ruleId).evaluate()
};
X.prototype=new z;
X.prototype.evaluate=function(a){f.logGroupStart("Evaluating And Node");
a=this.left.evaluate(a)&&this.right.evaluate(a);
f.logGroupEnd();
return a
};
Y.prototype=new z;
Y.prototype.evaluate=function(a){f.logGroupStart("Evaluating Or Node");
a=this.left.evaluate(a)||this.right.evaluate(a);
f.logGroupEnd();
return a
};
Z.prototype=new z;
Z.prototype.evaluate=function(a){f.logGroupStart("Evaluating Not Node");
a=!this.left.evaluate(a);
f.logGroupEnd();
return a
};
oa.prototype.toJSON=function(){return{label:this.getLabel(),value:this.getValue(),displayToAgent:this.getDisplayToAgent(),entityMaps:this.getMapper().getEntityMaps(),transcriptFields:this.getMapper().getTranscriptFields(),doKnowledgeSearch:this.getDoKnowledgeSearch()}
};
ba.prototype.map=function(a,b,c,e,d){"undefined"==typeof c&&(c=!0);
"undefined"==typeof e&&(e=!0);
"undefined"==typeof d&&(d=!0);
this.getEntityMaps().push(new pa(a,b,c,e,d))
};
ba.prototype.saveToTranscript=function(a){this.getTranscriptFields().push(a)
};
pa.prototype.toJSON=function(){return{entityName:this.getEntityName(),fieldName:this.getFieldName(),fastFill:this.getFastFill(),autoQuery:this.getAutoQuery(),exactMatch:this.getExactMatch()}
};
var I={};
p._=I;
I.handlePing=function(a){q.connection.handlePing(a)
};
I.error=function(a){a?f.log("Server Error: "+a):f.log("Server responded with an error.");
da()
};
I.warning=function(a){a?f.log("Server Warning: "+a):f.log("Server sent an anoymous warning.")
};
I.setNewPtid=function(a){v.setPermanentId(a)
};
I.clearStorage=function(){B.clear()
};
...
p.getSid=function(){return w
};
p.enableLogging=function(){S=!0
};
...
p.disconnect=function(){da()
};
p.startChat=function(a,b,c){(b?L(a,b):k[a]).startChat("liveagent"+Math.round(100000*Math.random())+(new Date).getTime(),c)
};
p.startChatWithWindow=function(a,b,c,e){(c?L(a,c):k[a]).startChat(b,e)
};
...
a.addTracker(new V(a.buttonId,b))
};
...
p.addButtonEventHandler=function(a,b){"function"==typeof b&&(ha[a]=b)
};
p.BUTTON_EVENT=l.EVENT;
p.setCustomVariable=function(a,b){ja[a]=b;
if(H.hasOwnProperty(a)){for(var c=0;
c<H[a].length;
c++){var e=u(H[a][c]);
...
return c
},linkToEntity:function(a,d){if(ka.hasOwnProperty(a)&&ka[a]==b.getEntityName()){return fa("Warning: Recursive links detected, skip link "+b.getEntityName()+" to "+a),c
...
for(var c=0;
c<a.length;
c++){d.messageHandler.call(window,a[c].type,a[c].message)
...
d.removePingScript=function(){null!==c&&(document.body.removeChild(c),c=null)
}
})();
q.connection=d;
...
qa.prototype.toJSON=function(){return{entityName:this.getEntityName(),saveToTranscript:this.getSaveTranscript(),showOnCreate:this.getShowOnCreate(),linkToEntityName:this.getLinkToEntityName(),linkToEntityField:this.getLinkToEntityField(),entityFieldsMaps:this.getEntityMapper().getEntityFieldsMaps()}
};
ra.prototype.map=function(a,b,c,e,d){"undefined"==typeof c&&(c=!0);
"undefined"==typeof e&&(e=!0);
"undefined"==typeof d&&(d=!0);
this.getEntityFieldsMaps().push(new sa(a,b,c,e,d))
};
sa.prototype.toJSON=function(){return{fieldName:this.getFieldName(),label:this.getLabel(),doFind:this.getDoFind(),isExactMatch:this.getIsExactMatch(),doCreate:this.getDoCreate()}
};
var w=f.getCookie("liveagent_sid"),ca=f.getCookie("liveagent_chatted"),ta=!1,S=!1,k={},za=[],Aa=[],ea=null,ha={},Q=null,ka={},R=!1,m={url:null,deploymentId:null,orgId:null,pingRate:50000,pingTimeout:5000,chatWindowWidth:482,chatWindowHeight:450,contentServerUrl:null,chatPage:"/s/chat",prechatHandler:"/s/prechatVisitor"};
q.connection.messageHandler=function(a,b){switch(a){case"VisitorId":b.sessionId&&(f.log("Received new session ID"),w=b.sessionId,document.cookie="liveagent_sid\x3d"+encodeURIComponent(w)+";path\x3d/;",null!=v.getVisitCount()&&v.setVisitCount(v.getVisitCount()+1),v.getPermanentId()||v.setPermanentId(w));
break;
case"Settings":B.init();
...
d&&xa(d,e);
break;
case"Invite":var e=b.buttons[c],g=null,g=e.inviteImageUrl?Da(e.id,e.inviteImageUrl,e.inviteImageWidth,e.inviteImageHeight):document.getElementById("liveagent_invite_button_"+e.id);
null==g?fa("Warning: Button "+e.id+" disabled because HTML element was not found"):(d=u(e.id),d.addTracker(new A(e.id,g,e.inviteRenderer,e.inviteStartPosition,e.inviteEndPosition,e.hasInviteAfterAccept,e.hasInviteAfterReject,e.inviteRejectTime)),g=f.jsonDecode(e.inviteRules),d.setRules(g.rules,g.filter),xa(d,e))
}}break;
case"Availability":c={};
for(e=0;
e<b.results.length;
...
case q.VisitorMessage.WARNING:fa(b.text);
break;
case q.VisitorMessage.ERROR:Ba(b.text);
da();
break;
...
q.connection.onSuccess=function(){wa()
};
q.connection.onError=function(a){Ba(a);
